...
export class Question {
    ...
    protected constructor(id: Number, category: QuestionCategories, question: String, answer: String, level: QuestionLevels, imageUrl: String | null = null, blurImage: boolean = false, video: RemoteVideo | null = null) {
        this.id = id;
    ...
    static createImage = (id: Number, category: QuestionCategories, question: String, answer: String, level: QuestionLevels, imageUrl: String, blurImage: boolean = false) : Question => {
        return new Question(id, category, question, answer, level, imageUrl, blurImage);
    }
    ...
    static createVideo = (id: Number, category: QuestionCategories, question: String, answer: String, level: QuestionLevels, video: RemoteVideo) : Question => {
        return new Question(id, category, question, answer, level, null, false, video);
    }
}
...
export class GameQuestion extends Question {
    ...
    constructor(number: Number, wordPosition: Number, question: Question) {
        super(question.id, question.category, question.text, question.answer, question.level, question.imageUrl, question.blurImage, question.video);
