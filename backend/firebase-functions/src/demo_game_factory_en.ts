import { Game, GameQuestion, QuestionCategories, Question, RemoteVideo, RemoteVideoSources } from './models';
        ...
        return new Game('earthquake', [
            ...
            new GameQuestion(
                ...
                Question.createText(
                    10,
                    QuestionCategories.ScienceOrMaths,
                    'The square root of 121 is ... ?', 'Eleven',
                    1
                )
            )
          ]);
